...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Example usage of createNewsItem (commented out - for reference only)
    /*
    ...
    const newNewsItem = createNewsItem({
        ...
        title: 'New Publication on Group Decision-Making',
        summary: 'Our team has published a new study in the Journal of Experimental Psychology.',
        fullContent: '<p>This groundbreaking study reveals new insights into how groups make decisions under pressure.</p><p>Additional details about the research findings and implications for practice.</p>'
    });
    
    // Add to the beginning of the news list
    newsContainer.insertBefore(newNewsItem, newsContainer.firstChild);
